...
def main():
    ...
    image_data = ImageDataInMemory.from_TartanAir('/home/dbutterfield3/Research/TartanAir/dataset/TartanGround/OldTownSummer/Data_ground/Pose2000', 'image_lcam_front', 'imu', 'image_lcam_front')
