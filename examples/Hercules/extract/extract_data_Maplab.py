...
def main():
    ...
    input_dir = '/media/nisemono/T7/GT/SLAM/Hercules_datasets/' + dataset_num + '/data/' + robot_name

    # Output bag path
    output_bag = '/media/nisemono/T7/GT/SLAM/Hercules_datasets/' + dataset_num + '/extract/bags_for_maplab/' + robot_name + '.bag'
