...
def main():
    ...
    robot_folder = "/media/dbutterfield3/T73/Hercules_datasets/" + dataset_version + "/results/openvins"
    est_data = OdometryData.from_txt_file(robot_folder + '/' + file_name, "world", "robot", CoordinateFrame.FLU, True, [0, 5, 6, 7, 4, 1, 2, 3])
    est_data.visualize([], ["OpenVINS EuRoC"], axes_interval=50, axes_length=0.3)
